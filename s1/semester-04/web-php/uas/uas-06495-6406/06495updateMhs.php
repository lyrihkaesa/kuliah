...
<body>
	...
	<div class="utama">
		...
		<div class="text-center"><a href="06495prnMhsPdf.php"><span class="fas fa-print">&nbsp;Print</span></a></div>
					...
					?>
						<tr>
							...
							<td>
								...
								<a class="btn btn-outline-danger btn-sm" href="06495hpsMhs.php?kode=<?php echo $row["id"] ?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
							</td>
						</tr>
				<?php
						$no++;
