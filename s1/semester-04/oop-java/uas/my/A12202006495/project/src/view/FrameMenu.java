...
public class FrameMenu extends JFrame {
    ...
    public FrameMenu() {
        ...
        int yDefault = 20;
        int labelWidth = 760;
        nameLabel.setBounds(XDefault, yDefault, labelWidth, 66);
        nameLabel.setFont(AppConfig.MyFont.TITLE);
        nameLabel.setForeground(AppConfig.MyColor.PURPLE200);

        addressLabel.setBounds(XDefault, nameLabel.getY() + nameLabel.getHeight(), labelWidth, 48);
