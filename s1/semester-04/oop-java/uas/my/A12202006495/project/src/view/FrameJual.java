...
public class FrameJual extends JFrame {
    private JLabel transactionIdLabel = new JLabel("ID Transaksi"),
            idItemLabel = new JLabel("Kode"),
            nameItemLabel = new JLabel("Nama"),
            priceItemLabel = new JLabel("Harga"),
            amountItemLabel = new JLabel("Jumlah"),
            totalLabel = new JLabel("Total"),
            payLabel = new JLabel("Bayar"),
            restLabel = new JLabel("Kembali"),
            brandLabel = new JLabel(AppConfig.FULLNAME_AUTHOR),
    ...
    public FrameJual() {
        ...
        brandLabel.setFont(AppConfig.MyFont.TITLE);
        brandLabel.setForeground(AppConfig.MyColor.PURPLE200);

        addressLabel.setBounds(15, 58, 450, 40);
        addressLabel.setFont(AppConfig.MyFont.SUBTITLE);
        addressLabel.setForeground(AppConfig.MyColor.PURPLE500);
