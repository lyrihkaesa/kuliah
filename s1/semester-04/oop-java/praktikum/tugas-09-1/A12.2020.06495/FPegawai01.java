...
public class FPegawai01 extends JFrame implements ActionListener {
    ...
    // rs=record set: yang mengontrol letak kursor terhadap suatu record(baris) yang
    // sedang aktif di suatu table.
    String[] header = { "NIP", "Nama", "Bagian", "Jenis Kelamin", "Password" };

    // DefaultTableModel untuk menampilkan model atau isinya
    // JTable adalah salah satu komponen dari package SWING yang dapat digunakan
    // untuk menampilkan/mengedit data dua dimensi dalam bentuk tabel, seperti
    // spreadsheet
    ...
    public FPegawai01() {
        ...
        // JDesktopPane adalah kelas wadah (container class) untuk membuat MDI (Multiple
        // Document Interface)
        JDesktopPane pPgw = new JDesktopPane();

        /* Mengatur letak objek Label Di container */
        // lnip.setBounds(20, 20, 150, 30); // 20 = posisi X; 20 = posisi Y; 100 =
        // Width; 30; Height = 30
        ...
        // getViewport() menamilkan isi tabel
    ...
    int Cari() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                fJenisKel.setText(rs.getString("jeniskelamin"));
    ...
    void tampiltabel() {
        try {
            ...
            while (rs.next()) {
                ...
                String JenisKel = rs.getString("jeniskelamin");
