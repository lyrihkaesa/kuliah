...
public class FrameMenu extends JFrame {
    ...
    private JLabel nameLabel = new JLabel(ProgramConfig.FULLNAME_AUTHOR),
            addressLabel = new JLabel(ProgramConfig.NIM);

    // constructor
    public FrameMenu() {
        setPreferredSize(new Dimension(800, 600));
        setTitle(ProgramConfig.PROGRAM_TITLE[2]);
    ...
    class BukaPegawai implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            // FPegawai06496 xPegawai = new FPegawai06496();
    ...
    class BukaBarang implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            // FBarang06496 xBarang = new FBarang06496();
    ...
    class BukaJual implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            // FJual06496 xJual = new FJual06496();
    ...
    class Laporan implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            // CetakBrg06496 xLaporan = new CetakBrg06496();
